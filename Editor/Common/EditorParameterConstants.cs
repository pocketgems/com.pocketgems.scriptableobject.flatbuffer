...
namespace PocketGems.Parameters.Common.Editor
{
    ...
    internal static class EditorParameterConstants
    {
        ...
        public static class AssemblyName
        {
            ...
            public const string ParametersEditorCommon = "PocketGems.Parameters.Common.Editor";
            public const string ParametersEditorCodeGeneration = "PocketGems.Parameters.CodeGeneration.Editor";
            public const string ParametersEditorDataGeneration = "PocketGems.Parameters.DataGeneration.Editor";
        ...
        public static class Template
        {
            public static string RootDirPath =>
                Path.Combine(new[] { "Packages", ParameterConstants.PackageName, "Editor", "Common", "Templates" });
        }
